...
(function () {
    ...
    function hidePopup() {
        ...
        $(".popup__wrap iframe").attr("src", "");
    }
})();

$(".js-video-link").click(function () {
    var video_src = $(this).data("video");
    $(".popup__wrap iframe").attr("src", video_src);
});
...
(function () {
    var program = $('.js-program-in'),
        item = $('.js-program-item');
    program.hover(function () {
        var thisProgram = $(this);
        item.removeClass('active');
        thisProgram.parents('.js-program-item').addClass('active');
    }, function () {
        item.removeClass('active');
    });
})();
